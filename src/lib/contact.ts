...
export const EMERGENCY_PHONE = "08003337867";
export const EMERGENCY_PHONE_DISPLAY = "0800 333-7867";
...
export const QUICK_WHATSAPP = [
  ...
  { title: "Baja de Servicio", number: WHATSAPP_MAIN_DISPLAY, hours: "9:00 a 17:00 h." },
];
